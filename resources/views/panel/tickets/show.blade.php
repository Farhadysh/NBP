    ...
    <div class="d-flex flex-column flex-wrap flex-md-row bg-light py-4" style="margin-top: 110px">
        <div class="col-md-12">
         ...
         align-items-center m-2">
                ...
                <a href="/panel/tickets" class="btn btn-sm btn-outline-warning font-small">بازگشت</a>
            </div>
            ...
            <div class="col-md-12 bg-white border medium-radius p-3">
                ...
                @if($ticket->file_url)
                    <form action="/panel/file/download" method="post">
                        @csrf
            ...
            <div class="mt-5 col-md-10 mx-auto">
                <form action="{{route('panel.replies.store')}}"
