    ...
    <div class="cover-register d-flex align-items-center justify-content-center">
        <div class=" col-12 col-sm-6 col-md-6 col-lg-4 mx-auto">
            <div class="shadow-login bg-light">
                <h4 class="border-left-login  py-3 pr-3">تایید کد</h4>
                <form class="login col-12" method="post" action="/password/verify" id="login">
                    @csrf
                    <div class="group col-12 p-0">
                        <input id="code" type="text" name="code"><span class="highlight"></span><span
                                class="bar"></span>
