        ...
        <div class="col-md-8 border-factor bg-white">
            ...
            <div class="row-factor d-flex justify-content-between flex-wrap-reverse  my-md-3 my-2 mx-md-4 mx-1">
                <div class="flex-column">
                    <div class="d-flex pr-2 text-factor my-2">
                ...
                <table class="table table-bordered p-3">
                    ...
                    @foreach($order->orderLists as $orderList)
                        <tr class="text-center">
                            ...
                            <td>{{number_format($orderList->company_price)}}</td>
                            <td>{{number_format($orderList->company_price * $orderList->count)}}</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
            ...
            <div class="d-flex justify-content-between flex-wrap-reverse p-md-5 my-5 my-md-0 ml-md-4">
                ...
                <div class="d-flex flex-column">
                    ...
                    <p> هزنینه ارسال : {{number_format($order->send_price)}}
                    </p>

                    <div class="d-flex mt-3">
                        <strong class="text-success"> جمع کل :‌ </strong>
                        <p class="pr-2 text-success">
                            {{number_format($total + $order->send_price)}}
                        </p>
                    </div>
                </div>
            </div>
            <a onclick="window.print()" class="btn btn-outline-secondary">
                <i class="fa fa-print float-left"></i>   چاپ فاکتور
            </a>
        </div>
    </div>
</div>
