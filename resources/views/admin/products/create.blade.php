...
@section('content')
    <div class="d-flex flex-wrap pt-md-5 pt-0 mt-0 mb-5">
        <form action="{{route('admin.products.store')}}" method="post"
            ...
            <div class="form-group col-md-4">
                <label for="limit_count">موجودی(اجباری)</label>
                <input type="text" class="form-control font-small"
                       id="limit_count"
                       name="limit_count" value="{{old('limit_count') ?? 30}}"
                       placeholder="موجودی">
            ...
            <div class="form-group col-md-4">
                <label for="limit_weight">وزن (گرم)(اجباری)</label>
                <input type="text" class="form-control font-small"
                       id="limit_weight"
                       name="limit_weight"
                       value="{{old('limit_weight') ?? 1}}"
                       placeholder="وزن">
            ...
            <div class="form-group col-md-4">
                ...
                <select name="sendDay" class="form-control font-small cat" id="sendDay">
            ...
            <div class="col-md-5 my-2 mx-auto">
                <div class="image-box">
                    <input name="image[]" id="one" type="file">
            ...
            <div class="col-md-5 my-2 mx-auto">
                <div class=" image-box">
                    <input name="image[]" id="two" type="file">
            ...
            <div class="col-md-5 my-2 mx-auto">
                <div class=" image-box">
                    <input name="image[]" id="three" type="file">
            ...
            <div class="col-md-5 my-2 mx-auto">
                <div class=" image-box">
                    <input name="image[]" id="four" type="file">
